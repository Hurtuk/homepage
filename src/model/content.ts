...
export class Content {
    ...
    public static readonly links: Group[] = [
        ...
        },
        {
            ...
            links: [
                { title: "YggTorrent", url: "https://www.yggtorrent.ch", icon: "yggtorrent.png", moreLink: "https://www2.yggtorrent.ch/engine/search?name=&description=&file=&uploader=&category=2145&sub_category=2183&option_langue%3Amultiple%5B%5D=2&do=search" },
    ...
    public static readonly searchEngines: Link[] = [
        ...
        { title: "YggTorrent", url: "https://www2.yggtorrent.ch/engine/search?do=search", argName: "name", color: "#69DEC2" }
    ];
}